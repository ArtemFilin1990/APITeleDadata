...
START_TEXT = (
    "Здравствуйте. Я ваш ассистент по проверке компаний в стиле Apple: "
    "просто, аккуратно и по делу.\n"
    "Что нужно сделать:\n"
    "1) Нажмите «🔎 Проверить ИНН».\n"
    "2) Введите ИНН или ОГРН.\n"
    "3) Получите основную карточку и кнопки-блоки для действий."
)
