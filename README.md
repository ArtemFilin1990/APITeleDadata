...
- После основного экрана доступны кнопки навигации по разделам: суды, штрафы/долги, проверки, контакты, налоги, документы и др.
- В экране «Подробнее» выводится полный дамп всех полей `data.*`, которые вернул DaData по вашему тарифу
