...
- Карточка в 1 экран + кнопки: «Подробнее», «Филиалы» (если есть), «Скопировать реквизиты»
...
5. Получите короткую карточку и используйте кнопки:
   ...
   - «🏢 Филиалы» — список филиалов (если есть)
   - «📋 Скопировать реквизиты» — готовый блок для CRM
